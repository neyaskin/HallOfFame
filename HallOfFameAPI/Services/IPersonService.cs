...
public interface IPersonService
{
    ...
    /// </summary>
    /// <param name="person"><seealso cref="PersonCreateDto"/></param>
    /// <returns></returns>
    ...
    /// <returns><seealso cref="PersonResponseDto"/></returns>
    Task<PersonResponseDto> UpdatePersonAsync(long id, PersonUpdateDto person);
